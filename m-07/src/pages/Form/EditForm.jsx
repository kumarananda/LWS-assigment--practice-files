...
function EditForm() {
  ...
  const [title, setTitle] = useState(jobEdit.title);
  const [type, setType] = useState(jobEdit.type);
  const [salary, setSalary] = useState(jobEdit.salary);
  const [deadline, setDeadline] = useState(jobEdit.deadline);
  const reset = () => {
    setTitle("");
    setType("");
    setSalary("");
