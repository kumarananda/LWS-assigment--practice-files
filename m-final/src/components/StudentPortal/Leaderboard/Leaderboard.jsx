...
import { useGetAssignmentMarkQuery, useGetAssignmentMarksQuery } from "../../../features/api/assignmentMark/assignmentMarkApi";
import { useGetQuizzessQuery } from "../../../features/api/quizzes/quizzesApi";

const Leaderboard = () => {
  const { data: quizzes, isLoading: qLoading, isSuccess: qSuccess, isError: qError } = {};
  const { data: q, isLoading: amLoading, isSuccess: aMSuccess, aMError: assMError } = useGetAssignmentMarksQuery();
  return (
    <>
      <div>
